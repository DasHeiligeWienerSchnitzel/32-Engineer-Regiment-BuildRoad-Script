...
_height = _nearestTruck getVariable ["ER32_buildRoad_sandHeight", -0.5];
...
_sandFilled = _nearestTruck getVariable ["ER32_buildRoad_sandFilled",0];
...
[_nearestTruck, 1, ["ACE_SelfActions"], ER32_buildRoad_sandDropper] remoteExecCall ["ace_interact_menu_fnc_addActionToObject",0];
[_nearestTruck, 1, ["ACE_SelfActions"], ER32_buildRoad_sandDropper_loopActive] remoteExecCall ["ace_interact_menu_fnc_addActionToObject",0];

sandTrucks pushBack _nearestTruck;
